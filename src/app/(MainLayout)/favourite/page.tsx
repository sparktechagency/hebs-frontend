    ...
    
{
    favouriteBooks?.data?.books?.map((book:any,_id:string)=>{
      return  <div className="bg-white rounded-lg shadow-lg p-6 max-w-xs mx-auto" key={_id}>
        ...
        <div className="mt-4 text-center">
          ...
          <div className="flex justify-center items-center mt-2">
            <span className="text-lg text-red-500 mr-2">${book.price.amount}</span>
  ...
  <Link href={`/bookStore/${book._id}`}>
          ...
          <button
            ...
            className="mt-4 w-full bg-orange-500 text-white hover:bg-orange-600 rounded-lg p-2"
          >
            View Details
          </button>
  </Link>
