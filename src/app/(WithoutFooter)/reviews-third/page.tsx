...
const BookReview3=()=> {
 ...
 <div className="max-w-4xl min-h-screen mx-auto bg-[#FFFFFF] rounded-lg shadow-2xl p-12 ">
    ...
    <div className="flex justify-center gap-8 bg-[#FFFFFF] rounded-lg shadow-2xl p-4 mt-8">
     <Link href={"/reviews-fourth"}>   <button className="h-10 w-36 rounded-full bg-white border border-black hover:bg-[#FF7F7F] hover:text-white hover:border-[#FF7F7F] transition-all uppercase">
                  Skip Book
                </button></Link>
                <Link href={"/reviews-fourth"}>
