...
console.log("plans>>>",plans?.data);
  return (
    ...
    <div className="max-w-2xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-8">Choose your plan option:</h1>

      <div className="space-y-6">
        {/* Monthly Plan */}
        <div
          className={`border rounded-3xl p-6 shadow-sm relative ${selectedPlan === "monthly" ? "border-blue-300" : "border-gray-200"}`}
        >
          <Radio
          ...
          <div className="flex items-center mb-4">
            ...
            <div className="w-2/3">
              <h2 className="text-2xl font-medium text-gray-700">Monthly Membership</h2>
              <div className="mt-2">
                <span className="text-3xl font-semibold text-red-400">$14.99</span>
