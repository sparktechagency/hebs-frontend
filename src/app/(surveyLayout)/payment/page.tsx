            ...
            <div className="border rounded-2xl p-6 shadow-sm bg-white">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input defaultValue="Eyasin Islam" size="large" className="rounded-lg" />
                </div>

                <div>
                  <label className="block text-sm text-gray-500 mb-1">Card Number</label>
                  <Input defaultValue="1867 8362 3828 3672 3839" size="large" className="rounded-lg" />
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm text-gray-500 mb-1">Expire Date</label>
                    <Input defaultValue="06/29" size="large" className="rounded-lg" />
                  </div>
                  <div>
                    <label className="block text-sm text-gray-500 mb-1">CVV</label>
                    <Input defaultValue="729" size="large" className="rounded-lg" />
                  </div>
                </div>
              </div>
            </div>
