...
const InsideTinyMuslim = () => {
   ...
   <h2 className={`text-4xl  text-black tracking-wider  ${styles.fontRozha}`}>
          Inside the Tiny Mu’mins        <span className="relative inline-block mr-3">
                Box
        ...
        <div className="flex flex-row justify-center gap-12 mt-12 p-4">  
         ...
         <p className={`${styles.fontInter}`}>Five hand-picked books, including engaging board books and picture books.</p>
          </div>
          ...
          <div className=" ">
            <div className="" />
 <div>
 <Image src={inside2} alt="Bilal Cooks Daal" width={512} height={512} className="w-[500px]" />
 <p className={`${styles.fontInter} mt-5 md:mt-0`}>Stickers, frameable artwork, and surprise extras.</p>
 </div>
          </div>
        </div>
      </div>
