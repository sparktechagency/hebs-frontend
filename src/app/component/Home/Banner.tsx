...
<div className="w-full bg-[#FDFBDF] px-4 py-8 md:py-12 lg:py-16">
      <section className="relative max-w-7xl mx-auto">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8">
          {/* Left Content */}
          <div className="w-full md:w-1/2 text-center md:text-left flex flex-col justify-center items-center md:items-start space-y-4 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
          ...
          <div className="w-full md:w-1/2 flex justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
            <Image 
              src={bannerImg} 
