  ...
  return (
    <div className="flex items-center justify-center bg-[#ffffff] px-4 py-16 relative">
      <div className="bg-[#FEECDE] w-full max-w-7xl flex flex-col md:flex-row items-center relative p-6 rounded-lg shadow-lg">
        ...
        <div className="absolute left-0 bottom-0 hidden md:block w-[180px] lg:w-[250px]">
          <Image
            src={img1}
        ...
        <div className="flex flex-col md:flex-row items-center w-full">
          ...
          <div className="w-full md:w-1/2 px-4 py-8 md:px-6 md:py-10 text-center md:text-left">
            ...
            <Button className="mt-6 bg-[#111111] border-none text-white w-full md:w-auto px-6 py-2 rounded-md">
              Subscribe
            </Button>
          </div>
        </div>
        ...
        <div className="absolute right-0 bottom-0 hidden md:block w-[180px] lg:w-[250px]">
          <Image
            src={img2}
            alt="Planet Omar"
            width={250}
