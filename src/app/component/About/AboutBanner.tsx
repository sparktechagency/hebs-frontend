          ...
          <div className="container mx-auto">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="w-full md:w-1/2 space-y-6">
                <div>
                  <h3 className={`text-[#FCB876] font-bold text-3xl mb-1 ${style.fontRozha}`}>ABOUT</h3>
                  <h2 className={`text-4xl md:text-5xl font-bold text-[#F37975] ${style.fontHotel}`}>
                  illuminate muslim minds
                  </h2>
                </div>
  
                <p className={`text-xl md:text-2xl font-medium text-[#333333] leading-snug ${style.fontRozha}`}>
                Who We Are:
                </p>
  
                <p className={ `text-base md:text-lg text-[#333333] ${style.fontPoppins}`}>
...
monthly subscriptions and engaging book fairs. Utilizing a
blend of expert recommendations and data science, we aim to provide a reading experience that is both enriching and enjoyable for children at every reading level. !
                </p>
